...
public class TC008 extends BaseClass {
	...
	@Test
	public void newUserRegistrationWithCompanyNameWithSpecialCharacter() {
		...
		String userFirstname = "ccqavendor";
		...
		rfpVerificationPage = rfpIndexPage.enterVendorDetails(userFirstname, userLastname,
				(userFirstname + userLastname + "@mailinator.com"));
		...
		logger.info("Clicked on create Button");
		pause(2);
		driver.navigate().to(inboxLink + userFirstname + userLastname + "#/#inboxpane");
