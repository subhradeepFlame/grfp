...
public class TC004 extends BaseClass {
	...
	public void rateAllfeature() {
		...
		testStepsLog("Step " + (stepCount++), " Click on down arrow.");
		rfpVerificationPage = rfpIndexPage.clickOnDownArrowForRating(q1);
		testStepsLog("Step " + (stepCount++), " Verify question-1 vendor 3 saved stars are showing correctly");
		List<WebElement> question1Vendor3StarsCount = driver
				.findElements(By.xpath("//md-content//div/span[contains(text(),'" + q1
						+ "')]/../../../following-sibling::tr[1]//div//tbody//td[normalize-space()='QaNarola Vendor1']/..//div[@class='jk-rating-stars-container ng-isolate-scope layout-row']//a[@class='button star-button ng-scope md-default-theme star-on']/i"));
		Assert.assertEquals(question1Vendor3StarsCount.size(), 5);
		testVerifyLog("starts are showing correctly for question 1 vendor 3");
		testStepsLog("Step " + (stepCount++), " Verify question-1 vendor 2 saved stars are showing correctly");
		List<WebElement> question1Vendor2StarsCount = driver
				.findElements(By.xpath("//md-content//div/span[contains(text(),'" + q1
						+ "')]/../../../following-sibling::tr[1]//div//tbody//td[normalize-space()='QaNarola Vendor']/..//div[@class='jk-rating-stars-container ng-isolate-scope layout-row']//a[@class='button star-button ng-scope md-default-theme star-on']/i"));
		Assert.assertEquals(question1Vendor2StarsCount.size(), 6);
		testVerifyLog("starts are showing correctly for question 1 vendor 2");
